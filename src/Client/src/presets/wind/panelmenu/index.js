export default {
    ...
    transition: {
        ...
        enterActiveClass: 'overflow-hidden property-[max-height] duration-1000 ease-[cubic-bezier(0.42,0,0.58,1)]',
        enterToClass: 'max-h-[1000px]',
        leaveFromClass: 'max-h-[1000px]',
        leaveActiveClass: 'overflow-hidden property-[max-height] duration-[450ms] ease-[cubic-bezier(0,1,0,1)]',
